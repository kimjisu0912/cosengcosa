 				...
 				<tbody>
 					...
 					<c:if test="${searchOption and not empty classMainList }">
 						<c:forEach var="c" items="${classMainList }">
 							<tr class="table-light">
 								<td>${c.cmNo }</td>
 								<td><a href="classMainDetail?cmNo=${c.cmNo }&pageNum=${currentPage}&type=${type}&keyword=${keyword}">${c.cmName }</a></td>
 								<td>${c.cmPrice }</td>
 								<td>${c.cmStar }</td>
 							</tr>
 						</c:forEach>
 					...
 					<c:if test="${not searchOption and not empty classMainList }">
 						<c:forEach var="c" items="${classMainList }">
 							<tr class="table-light">
 								<td>${c.cmNo }</td>
 								<td><a href="classMainDetail?cmNo=${c.cmNo }&pageNum=${currentPage}">${c.cmName }</a></td>
 								<td>${c.cmPrice }</td>
 								<td>${c.cmStar }</td>
 							</tr>
 						</c:forEach>
