...
<div class="row my-5" id="global-content">
	<div class="col">
		...
		<form name="writeFormBoard" action="writeProcessFreeBoard" id="writeFormBoard" 
			class="row g-3 border-primary" method="post" enctype="multipart/form-data">
		  	<div class="col-4 offset-md-2">
			    <label for="writer" class="form-label">작성자</label>
			    <input type="text" class="form-control" name="fWriter"  id="fWriter" 
			...
			<div class="col-8 offset-md-2">
			    ...
			    <textarea class="form-control" name="fContent" id="fContent" rows="10"></textarea>
	  		</div>
