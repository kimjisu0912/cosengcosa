...
<div class="row my-5" id="global-content">
	<div class="col">
		<div class="row my-3 text-center">
			<div class="col">
				<h2 class="fs-3 fw-bold">결재 하기</h2>${classmain.cmTitle }${classmain.cmPrice }${sessionScope.member.id }${sessionScope.member.name }
			</div>
		</div>
			...
			<div class="row my-3">
				<div class="col-8 offset-2">
					<div class="row">
						...
						<div class="col-auto">
							<input type="text" class="form-control text-bg-secondary " name="csCode" id="csCode" value="" readonly>
						</div>
					</div>
				</div>
			</div>
			<div class="row my-3">
				<div class="col-8 offset-2">
					<div class="row">
						...
						<div class="col-auto">
							<input type="text" class="form-control text-bg-secondary" name="csGroup" id="csGroup" value="" readonly>
						</div>
					</div>
				</div>
			</div>
