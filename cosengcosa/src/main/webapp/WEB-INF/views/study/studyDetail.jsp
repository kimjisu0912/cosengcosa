...
<div class="row my-5" id="global-content">
	<div class="col">
		...
		<div class="row text-center">
			<div class="col">
				<h2 class="fs-3 fw-bold">지식공유 상세보기</h2>
			</div>
		</div> 
		<div class="row my-3">
			<div class="col">
				<table class="table table-bordered" >
					<tbody>					
						<tr>
							...
							<td colspan="3">${ study.sTitle }</td>		
						</tr>
						<tr>
							<th>글쓴이</th>
							<td>${ study.sAskid }</td>
							<th>작성일</th>
							<td><fmt:formatDate value="${ study.sCdate }" 
						...
						<tr>
							<th>파&nbsp;&nbsp;&nbsp;&nbsp;일</th>
							<td colspan="3">
							<c:if test="${ empty study.sFile }">
								첨부파일 없음
							</c:if> 
							<c:if test="${ not empty study.sFile }">
								<a href="resources/upload/${ study.sFile }">파일 다운로드</a>
							</c:if>
							</td>		
						</tr>
						<tr>		
							<td colspan="4">
								<pre>${ study.sAskcontent }</pre>
							</td>
						</tr>	
					</tbody>
				</table>
