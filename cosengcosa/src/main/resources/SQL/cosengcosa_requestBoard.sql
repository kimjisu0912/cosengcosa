...
VALUES (requestboard_seq.NEXTVAL,'회원','분명 회원가입을 했었는데 로그인이 안되고 아이디, 비밀번호 찾기도 안되요','분명 회원가입을 했었는데 로그인이 안되고 아이디 비밀번호 찾기도 안되요 빨리 해결해 주시면 감사하겠습니다.','test01','사이트 이용에 불편을 드려 죄송합니다. 우선 회원가입 되어있는지 확인해본 결과 회원가입이 되어있지 않다고 나왔습니다.귀찮으시겠지만 한번 더 회원가입을 해주시기 바랍니다.','Y','2023-01-09-12:20:00','Y');
INSERT INTO requestboard (r_no, r_code, r_title, r_content, r_writer , r_answer,r_count, r_open, r_cdate, r_yn) 
VALUES (requestboard_seq.NEXTVAL,'결제','강의를 결제했는데 내 강의실에 강의가 없습니다.','결제한 강의가 내 강의실에 없습니다. 결제는 되서 돈만 나간 상황입니다.', 'test01','사이트 이용에 불편을 드려 죄송합니다. 사이트 오류로 인해 일시적인 현상입니다. 결제 금액은 환불해드렸습니다.','Y','2023-01-06-18:25:10','Y');
INSERT INTO requestboard (r_no, r_code, r_title, r_content, r_writer , r_answer,r_count, r_open, r_cdate, r_yn) 
VALUES (requestboard_seq.NEXTVAL,'결제','강의 중간에 영상이 몇개 빠져있습니다','결제한 강의를 듣고 있었는데 중간에 몇몇 영상이 없는것처럼 다음 영상이 어색합니다. 중간에 영상이 빠진것 같은데 확인 좀 해주세요', 'test01','사이트 이용에 불편을 드려 죄송합니다. 다시 확인하시면 정상적으로 수업을 들을 수 있을겁니다.','Y','2023-01-04-20:50:18','Y');
INSERT INTO requestboard (r_no, r_code, r_title, r_content, r_writer , r_answer,r_count, r_open, r_cdate, r_yn) 
VALUES (requestboard_seq.NEXTVAL,'회원','아이디를 못 찾겠습니다.','오랜만에 접속하는거라 아이디를 못 찾겠습니다.', 'test01','아이디는 asdasd123 입니다','Y','2023-01-05-22:40:38','Y');
INSERT INTO requestboard (r_no, r_code, r_title, r_content, r_writer , r_answer,r_count, r_open, r_cdate, r_yn) 
VALUES (requestboard_seq.NEXTVAL,'결제','강의 결제가 안됩니다','강의를 결제하려고 하는데 결제창에서 오류가 뜨고 결제가 안됩니다.', 'test01','사이트 이용에 불편을 드려 죄송합니다. 다시 확인하시면 정상적으로 결제하실 수 있습니다.','Y','2023-01-08-21:55:58','Y');
