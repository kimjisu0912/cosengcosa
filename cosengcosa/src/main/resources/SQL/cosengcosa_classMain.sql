...
select cs_code, cs_video from classsub ;
...
VALUES (classmain_seq.NEXTVAL, 'JA01', '자바 기초 프로그래밍 강좌', '동빈나','자바 개발자들을 위한 입문수업입니다. 자바에대한 기초적인 기본 문법부터 시작하여 다향한 내용을 공부할 예정입니다. 이 수업을 통해 학습자들은 올바른 자바 프로그래밍을 배우고 실무에서도 적용할수 있는 실습을 통해 실력이 향상될 것입니다.', 4, 200000, 0, 30, 1, 'wjLwmWyItWI', 'Y');
INSERT INTO classmain (cm_no,  cm_code, cm_title, cm_name, cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star,  video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'JA02', '자바의 정석 기초편(2020최신)','남궁성의 정석코딩','자바의 정석 기초 자바강좌입니다. 자바를 공부하시는 자바 초보자들을 대상으로 진행하며, 기초적인 문법과 더불어 실제 클래스를 만들어 어떤식으로 작성하는 지 실습을 통해 강의를 보퉁하는 방식으로 진행하고 있습니다.', 5, 250000, 0, 65, 3, 'oJlCC1DutbA', 'Y');
INSERT INTO classmain (cm_no,  cm_code, cm_title, cm_name, cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star,  video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'JA03', '자바(JAVA)강의','홍드로이드','안녕하세요 홍드로이드입니다. 이번 강좌는 백엔드 프로그래머들을 위한 자바강의를 진행합니다. 구성으로는 잘 사용하는 java프로그램을 설치하고, 자바의 기본적인 문법의 설명과 더불어 실습을 통해 자바에 대해 이해하고 활용할수 있게 되는것이 이번 강좌의 목표입니다. 짧고 간결하게 준비하여 쉽고 재미있게 배울수 있을것이라 생각합니다.  ' ,6, 180000, 0, 15, 2, '6Hd4pPRb1eY', 'Y');
INSERT INTO classmain (cm_no, cm_code,cm_title, cm_name,cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star,  video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'DB01', '오라클(Oracle) SQL 강의 강좌','뉴렉처','오라클 SQL 학습, 왜 필요할까요? 오라클은 업계에서 가장 유명한 DBMS(DataBase Management System) 중 하나입니다. 오라클은 DBMS 관리를 위한 프로그래밍 언어, SQL을 통해 관리할 수 있습니다. 실력있는 자바 백엔드 웹 개발자 내지 데이터베이스를 잘 활용하는 개발자로 나아가기 위해서는 SQL을 통해 오라클을 다룰 줄 알아야 합니다. 특히 자바 백엔드 웹 개발자에게는 필수적인 발판이 될 과정입니다. ', 3, 150000, 0, 45, 3, 'pGlkIFrY9QY', 'Y');
INSERT INTO classmain (cm_no,  cm_code,cm_title, cm_name, cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star,  video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'DB02', '[SQL 기초강의] 혼자 공부하는 SQL(MySQL 8.0)','한빛미디어','어떻게 공부해야 할지 아직감이 잡히지 않으신가요? 학원에서 공부하기엔 너무 비싸고, 혼자공부하기엔 기초를 쌓기 어렵다 느끼시는 분들! 기초와 실습을 동시에 갖추고, DB의 개념적인 부분까지 싹 모아 완강후 나도 DB를 다룰줄 아는 사람이 될수 있습니다. ', 4, 240000, 0, 16, 1, '0cRhit1EJM0', 'Y');
INSERT INTO classmain (cm_no, cm_code,cm_title, cm_name,cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star,  video, cm_yn) 
...
INSERT INTO classmain (cm_no, cm_code,cm_title, cm_name,cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'JS01', '자바스크립트 기초 강좌 : 100분 완성 / 중급강좌 : 140분 완성','코딩앙마','약 2시간만 쓰면 기초탈출! JavaScript 를 초심자가 듣을수 있는 기초 강좌와 중급자들이 듣는 중급강좌로 나누어 준비했습니다. 중급자분들의 경우 바로 중급으로 넘어가도 괜찮지만, JavaScript가 처음이신 분들은 기초 강좌를 먼저 듣고 들어주시면 감사드립니다. 총 4시간으로 구성되어 있습니다.  ', 4, 260000, 0, 52, 3,  'KF6t61yuPCY', 'Y');
INSERT INTO classmain (cm_no, cm_code,cm_title, cm_name,cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star,  video, cm_yn) 
...
INSERT INTO classmain (cm_no,  cm_code,cm_title, cm_name,cm_content,cm_period, cm_price, cm_count, cm_recommend, cm_star,video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'SP02', 'Springboot 강좌 - 개념정리','메타코딩','본 과정은 자바 프로그래밍을 기초로 Spring Framework에 대한 개념과 용어, 동작에 대해 집중해서 학습할 수 있습니다. 그렇기에 Spring boot학습하기에 앞서 Spring MVC project 를 학습하시고 정확한 개념과 동작원리를 이해하신 후에 들어주시면 좋겠습니다.', 10, 220000, 0, 87, 3, 'XBG6CUtVCIg', 'Y');
INSERT INTO classmain (cm_no, cm_code,cm_title, cm_name, cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'SP03', '스프링 부트 게시판 무작정 따라하기', '한코딩','안녕하세요 한코딩입니다. 이번 강좌는 스프링 부트를 이용한 게시판만들기를 진행합니다. 어렵게 구성하기 보다는 모두가 쉽고 재밋게 접할 수 있도록 최대한 간단하게 구성하였기에 크게 부담감을 가지실 필요는 없을것이라 생각합니다. ', 6, 110000, 0, 56, 3, 'frI5CoZe-vE', 'Y');
INSERT INTO classmain (cm_no, cm_code, cm_title, cm_name, cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'SP04', 'Spring 5 for Beginner','나무소리','초보자들을 위한 spring 강좌입니다. 프로젝트의 기본개념부터 시작하여 Spring Framework, Spring MVC, Spring Boot, Spring Data JPA 등등 이러한 개념적인 부분을 짚고 넘어가는 강의입니다. 이후 이론을 통해 실제로 프로그래밍하여 어떻게 진행하는지 짧게 공부합니다. ', 6, 120000, 0, 77, 4, 'XL39DGSsYCs', 'Y');
INSERT INTO classmain (cm_no, cm_code,cm_title, cm_name, cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'BS01', '부트스트랩 실전강좌(Bootstrap tutoial)','온코딩빠찌','아직도 직접 css값을 줘서 작성하시나요? 이것만 있으면 당신도 1분이면 페이지 작성완료! 부트스트랩에 대해 궁금하시다면 같이 배워보시는건 어떠신가요? 페이지를 들어가서 직접 설명하고 함께 작성하여 초보자도 따라할수 있습니다. ', 2, 100000, 0, 88, 4, 'NWxVuHl4i5Y', 'Y');
INSERT INTO classmain (cm_no, cm_code,cm_title, cm_name, cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'BS02', 'bootstrap','생활코딩','뷰를 작성하는데 시간이 오래 걸리지 않으신가요? 그렇다면 이 부트스트랩을 한번 들어보세요! 당신의 시간을 절약해 주는 데 요긴하게 사용할 것이라 생각합니다. 본 강좌는 부트스트랩에 대한 설명으로 기본적으로 HTML/CSS강좌를 들었던 분들을 대상으로 진행하고 있습니다. 잘 이해가 안될수도 있기에 만일 처음배우시는 분들은 먼저 HTML기초 강좌를 수강하고 들어주시면 감사합니다. ', 8, 220000, 0, 99, 2, 'HKtD3d9C69U', 'Y');
INSERT INTO classmain (cm_no, cm_code,cm_title, cm_name,cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'KT01', '디모의 Kotlin 강좌','테크과학!DiMo','이 동영상은 프로그래밍을 처음 접하신 분들을 위한 코틀린 강좌입니다. 코틀린은 2011년 7월에 처음 나온 새로운 언어로, 문법도 지금까지의 프로그래밍 언어의 노하우가 담긴 훌륭한 언어로 되어있습니다. 그리고 자바와 완전 호완이 가능해 배워두신다면 분명 도움이 될것이라 생각하고 있습니다. 그리고 본 강좌를 위해 자바를 들어보시면 좋지만, 그렇지 않더라도 쉽게 접근할 수 있도록 쉽게 강의하고 있습니다.  ', 5, 120000, 0, 79, 4, '8RIsukgeUVw', 'Y');
INSERT INTO classmain (cm_no, cm_code,cm_title, cm_name, cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'KT02', '안드로이드(Android Kotlin)','홍드로이드','안녕하세요, 홍드로이드입니다. 이번 강좌에서는 안드로이드를 개발하는데에 중요한 코틀린에 대해 강의를 하려고 합니다. 자바와 비슷하게 되어있는 코틀린은, 자바와 비교해서 크게 다르지 않아 조금만 배운다면 금방 이해하게 되실거라 생각합니다. 이번 강좌에서는 깊게 들어가기 보다는 안드로이드와 관련해서 가볍게 들어갈 예정입니다. 따라서 자바를 공부하신 적이 없더라도 가볍게 들어주시면 감사드립니다.  ', 5, 250000, 0, 19, 1, 'IaXhn_I_ziY', 'Y');
INSERT INTO classmain (cm_no, cm_code,cm_title, cm_name, cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'KT03', '[Do it! 깡샘의 안드로이드 앱 프로그래밍 with 코틀린] 동영상 강의','깡샘','이 강좌는 앱 프로그래밍의 코틀린을 중심으로 강좌를 진행하고 있습니다. 처음 프로그래밍에 접하시거나, 앱 프로그래밍을 배워보고 싶은 분들 모두 이 강좌를 끝까지 듣고 나신다면 분명 간단한 앱을 만드실수 있으시리라 생각듭니다. 그외 강의에 대해 잘 모르시거나, 질문이 있으시다면 커뮤니티에 글을 올려주시면 감사드립니다. ', 6, 120000, 0, 46, 4, 'cnXIHesZtyk', 'Y');
INSERT INTO classmain (cm_no, cm_code,cm_title, cm_name, cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'HL01', '입문자를 위한 HTML 기초강의','유노코딩','안녕하세요, 유노코딩입니다. 이번 강좌에서는 정말로 순수하게 프로그래밍에 대해 잘 모르는 사람들을 위한 기초강의를 준비했습니다. HTML을 통해 프로그래밍이란 무엇인지를 이해하고, 직접 같이 따라해 보아 실전 연습에도 도움이 될수 있도록 구성하고 있습니다. 흥미가 있으신 분들은 같이 공부해 봅시다. ', 2, 100000, 0, 98, 1, '8kJwTrs6e-4', 'Y');
INSERT INTO classmain (cm_no, cm_code,cm_title, cm_name, cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'HL02', 'HTML/CSS 기초강의','수코딩','프로그래밍에 대해 처음 배우시나요? 이번 강좌는 프로그래밍의 첫 시작이라고도 할 수 있는 HTML과 CSS에 대해 쉽게 배워봅니다. 물론 이론뿐이 아닌 실제로 페이지를 제작해 봄으로써 몸에 익힐 수 있도록 구성하고 있습니다.', 2, 100000, 0, 100, 4,  'ltvaJ6vr19M', 'Y');
INSERT INTO classmain (cm_no, cm_code,cm_title, cm_name, cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn)  
VALUES (classmain_seq.NEXTVAL, 'HL03', 'HTML/CSS강의','짐코딩의 CODING GYM','HTML이나 CSS의 기초와 코딩의 흐름을 배우면서 강사와 함께 심플한 웹페이지를 제작합니다. 내용면에서 아주 기초적인 내용이므로, 주로 지식이 없는 분들이 배우시는 것을 추천드립니다. ', 3, 120000, 0, 72, 2, 'N_nVDZSAjq4', 'Y');
INSERT INTO classmain (cm_no , cm_code,cm_title, cm_name,cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'HL04', 'HTML + CSS + JS 미니 프로젝트 실습(프론트엔드 개발자 입문편)','수코딩','본 강좌는 주로 프론트엔드에 집중되어 있는 HTML과 CSS, JavaScript 를 전부 들을 수 있는 종합과목으로 구성되어 있습니다. 실습을 하면서 진행하며, 본 강좌를 완강하시게 된다면, 간단한 사이트를 스스로 만들어 내며, 다른 사람들이 만든 페이지조차 이해할수 있게 되며 간단하게 변경하거나 제작 하실수 있을것입니다. ', 6, 180000, 0, 78, 5, 'e56H5n1SvEs', 'Y');
INSERT INTO classmain (cm_no , cm_code,cm_title, cm_name,cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn)  
...
INSERT INTO classmain (cm_no , cm_code,cm_title, cm_name,cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'AJ01', 'WEB3-AJAX','생활코딩','본 강좌는 AJAX수업입니다. ajax는 자바스크립트와 비슷하면서도 ajax는 자바스크립트에서는 부족했던 효율적으로 웹서버에 정보를 요청하여 부분적으로 정보를 갱신해주는 기술입니다. 그래서 이런 ajax라는 기술이 무엇인지, 그리고 더 나아가서는 웹 애플리케이션이 어떻게 나아가는지를 하나씩 하나씩 밟아가며 배워보도록 합시다. 본 강좌는 자바스크립트를 기반으로 수업을 나가기에, 자바스크립트를 모르시는 분들은 반드시 자바스크립트를 수강하시고 오시는것을 권고합니다.', 4, 220000, 0, 100, 3, 'w077w7FN-pg', 'Y');
INSERT INTO classmain (cm_no , cm_code,cm_title, cm_name,cm_content, cm_period, cm_price, cm_count, cm_recommend, cm_star, video, cm_yn) 
VALUES (classmain_seq.NEXTVAL, 'AJ02', 'AJAX 다뤄보기', '코딩레시피','이메일 또는 아이디 중복확인, 댓글처리 등에 사용하는 비동기 통신방식인 ajax에 대한 내용을 다룹니다. 이번 강좌를 통해서 front페이지에서 ajax의 요청방법이나 javaScript로 어떻게 활용하는지 등등 이론과 실습을 통해 배워보도록 하겠습니다.', 6, 240000, 0, 62, 3, 'MolPGSmnLQc', 'Y');
...
SELECT COUNT(b.cs_video) as cmVideo FROM
 ...
 SELECT
   ...
   --------------------------------------------------------------------------------------      
    ...
    select cm_price, cm_period from classmain ;
